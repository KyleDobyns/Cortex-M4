...
extern void* _memmove(void*, const void*, int);
*/
...
int main( ) {
	...
	/***Extra Credit Tests***
   // Test _memset (extra credit)
   _memset(stringB, 'X', 10);
	    
	 // Test _strlen (extra credit)
   int length = _strlen(stringB);
	 
	 // Test _memmove
  char overlapTest[20] = "1234567890";
  _memmove(overlapTest + 4, overlapTest, 6);
